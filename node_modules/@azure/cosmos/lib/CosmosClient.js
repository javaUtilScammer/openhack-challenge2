...
class CosmosClient {
    constructor(options) {
        ...
        options.connectionPolicy = options.connectionPolicy || new documents_1.ConnectionPolicy();
        ...
        const globalEndpointManager = new globalEndpointManager_1.GlobalEndpointManager(this.options, (opts) => __awaiter(this, void 0, void 0, function* () { return this.getDatabaseAccount(opts); }));
