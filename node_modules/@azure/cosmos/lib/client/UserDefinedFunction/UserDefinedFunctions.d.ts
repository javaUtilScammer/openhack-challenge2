...
export declare class UserDefinedFunctions {
     ...
     * @param options
     */
    query(query: SqlQuerySpec, options?: FeedOptions): QueryIterator<UserDefinedFunctionDefinition>;
    /**
     ...
     * ```
     */
    readAll(options?: FeedOptions): QueryIterator<UserDefinedFunctionDefinition>;
    /**
