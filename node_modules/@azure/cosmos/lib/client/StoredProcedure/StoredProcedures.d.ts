...
export declare class StoredProcedures {
     ...
     * ```
     */
    query(query: SqlQuerySpec, options?: FeedOptions): QueryIterator<StoredProcedureDefinition>;
    /**
     ...
     * ```
     */
    readAll(options?: FeedOptions): QueryIterator<StoredProcedureDefinition>;
    /**
