...
function getHeaders(authOptions, defaultHeaders, verb, path, resourceId, resourceType, options, partitionKeyRangeId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (authOptions &&
            (authOptions.partitionResolver === undefined || // TODO: paritionResolver does not exist
                authOptions.partitionResolver === null)) {
