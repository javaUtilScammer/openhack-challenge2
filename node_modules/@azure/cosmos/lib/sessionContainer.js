...
class SessionContainer {
    constructor(hostname, collectionNameToCollectionResourceId = {}, 
    ...
    getPartitionKeyRangeIdToTokenMapPrivate(isNameBased, rId, resourceAddress) {
        ...
        if (!isNameBased) {
            ...
            resourceAddress = common_1.Helper.trimSlashes(resourceAddress);
    ...
    setSessionToken(request, resHeaders) {
        // TODO: any request
        if (resHeaders && !this.isReadingFromMaster(request["resourceType"], request["opearationType"])) {
            ...
            if (sessionToken) {
                ...
                const collectionName = common_1.Helper.getContainerLink(ownerFullName);
