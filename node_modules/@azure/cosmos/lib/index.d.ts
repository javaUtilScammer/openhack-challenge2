...
export { ConnectionMode, ConsistencyLevel, ConnectionPolicy, DatabaseAccount, DataType, Index, IndexedPath, IndexingMode, IndexingPolicy, IndexKind, LocationsType, MediaReadMode, PartitionKey, PartitionKeyDefinition, PartitionKind, PermissionMode, QueryCompatibilityMode, TriggerOperation, TriggerType, UserDefinedFunctionType } from "./documents";
