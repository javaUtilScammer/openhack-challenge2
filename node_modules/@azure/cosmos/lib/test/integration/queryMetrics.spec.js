...
describe("QueryMetrics", function () {
    ...
    const assertQueryMetricsEquality = function (queryMetrics1, queryMetrics2) {
        ...
        assert.deepEqual(queryMetrics1.queryPreparationTimes.logicalPlanBuildTime, queryMetrics2.queryPreparationTimes.logicalPlanBuildTime);
        assert.deepEqual(queryMetrics1.queryPreparationTimes.physicalPlanBuildTime, queryMetrics2.queryPreparationTimes.physicalPlanBuildTime);
        assert.deepEqual(queryMetrics1.queryPreparationTimes.queryCompilationTime, queryMetrics2.queryPreparationTimes.queryCompilationTime);
        assert.deepEqual(queryMetrics1.queryPreparationTimes.queryOptimizationTime, queryMetrics2.queryPreparationTimes.queryOptimizationTime);
        assert.deepEqual(queryMetrics1.runtimeExecutionTimes.queryEngineExecutionTime, queryMetrics2.runtimeExecutionTimes.queryEngineExecutionTime);
        assert.deepEqual(queryMetrics1.runtimeExecutionTimes.systemFunctionExecutionTime, queryMetrics2.runtimeExecutionTimes.systemFunctionExecutionTime);
        assert.deepEqual(queryMetrics1.runtimeExecutionTimes.userDefinedFunctionExecutionTime, queryMetrics2.runtimeExecutionTimes.userDefinedFunctionExecutionTime);
