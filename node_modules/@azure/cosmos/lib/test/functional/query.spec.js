    ...
    describe("Validate QueryIterator Functionality", function () {
        ...
        const queryIteratorExecuteNextTest = function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                assert(headers[__1.Constants.HttpHeaders.RequestCharge] > 0, "RequestCharge has to be non-zero");
                ...
                assert(headersWithContinuation[__1.Constants.HttpHeaders.RequestCharge] > 0, "RequestCharge has to be non-zero");
