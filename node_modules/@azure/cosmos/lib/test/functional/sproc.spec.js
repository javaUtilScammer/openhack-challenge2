...
describe("NodeJS CRUD Tests", function () {
    ...
    it("nativeApi Should enable/disable script logging while executing stored procedure", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert.equal(headers1[__1.Constants.HttpHeaders.ScriptLogResults], undefined);
            ...
            assert.equal(headers2[__1.Constants.HttpHeaders.ScriptLogResults], encodeURIComponent("The value of x is 1."));
            requestOptions = { enableScriptLogging: false };
            const { body: result3, headers: headers3 } = yield container
                .storedProcedure(retrievedSproc.id)
                .execute([], requestOptions);
            assert.equal(result3, "Success!");
            assert.equal(headers3[__1.Constants.HttpHeaders.ScriptLogResults], undefined);
        });
    });
});
