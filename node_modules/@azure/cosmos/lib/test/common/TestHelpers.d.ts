...
import { ContainerDefinition, ItemDefinition, ItemResponse, PermissionResponse, TriggerResponse, User, UserDefinedFunctionResponse } from "../../client";
...
export declare function bulkInsertItems(container: Container, documents: any[]): Promise<Array<ItemDefinition & ItemBody>>;
