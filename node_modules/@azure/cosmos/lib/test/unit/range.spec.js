...
describe("Range Tests", function () {
    describe("constructor", function () {
        ...
        it("options - undefined (ommited argument)", function () {
            assert(new range_1.Range());
        });
        it("options - undefined (literal argument)", function () {
            assert(new range_1.Range(undefined));
        });
    ...
    describe("_containsRange", function () {
        const range = new range_1.Range({ low: 1, high: 3 });
        it("numbers, default comparison", function () {
            assert(range._containsRange(new range_1.Range({ low: 20, high: 29 })));
        });
        it("numbers, custom comparison", function () {
            assert(!range._containsRange(new range_1.Range({ low: 20, high: 29 }), function (a, b) {
                return a > b ? 1 : -1;
            }));
        });
    });
    ...
    describe("_compare", function () {
        ...
        it("(x, undefined) < 0", function () {
            ...
            assert(r._compare(NaN, undefined) < 0);
            assert(r._compare(true, undefined) < 0);
            assert(r._compare(false, undefined) < 0);
    ...
    describe("_isRange", function () {
        it("_isRange(undefined) is false", function () {
            assert(!range_1.Range._isRange(undefined));
        });
        it("_isRange(null) is false", function () {
            assert(!range_1.Range._isRange(null));
        });
        it("_isRange(non-object) is false", function () {
            ...
            for (const point of points) {
                assert(!range_1.Range._isRange(point));
            }
        });
        it("_isRange(point) is false", function () {
            ...
            for (const range of ranges) {
                assert(!range_1.Range._isRange(range));
            }
        });
    });
});
